...
export const productsData: any = {
  KA: [
    ...
    { id: 60, name: "სომხური კურაგა", price: "45₾", category: "ჩირი", img: "/products/kuraga.jpg" },
  ...
  EN: [
    ...
    { id: 60, name: "Armenian Dried Apricots", price: "45₾", category: "Dried Fruit", img: "/products/kuraga.jpg" },
  ...
  RU: [
    ...
    { id: 60, name: "Армянская курага", price: "45₾", category: "Сухофрукты", img: "/products/kuraga.jpg" },
